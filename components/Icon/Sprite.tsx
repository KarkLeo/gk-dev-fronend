...
<svg width="0" height="0" class="hidden">
  ...
  <!-- 
    Social icons
  -->
  <symbol aria-hidden="true" data-prefix="fab" data-icon="twitter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="twitter-si">
  ...
  <symbol aria-hidden="true" data-prefix="fab" data-icon="youtube" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" id="youtube-si">
    <path fill="currentColor" d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path>
  </symbol>
  <symbol aria-hidden="true" data-prefix="fab" data-icon="linkedin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" id="linkedin-si">
    <path fill="currentColor" d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"></path>
  </symbol>
  <symbol aria-hidden="true" data-prefix="fab" data-icon="whatsapp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" id="whatsapp-si">
  ...
  <symbol aria-hidden="true" data-prefix="fab" data-icon="facebook-square" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" id="facebook-si">
    <path fill="currentColor" d="M400 32H48A48 48 0 000 80v352a48 48 0 0048 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0048-48V80a48 48 0 00-48-48z"></path>
  </symbol>
  <symbol aria-hidden="true" data-prefix="fab" data-icon="telegram-plane" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" id="instagram-si">
    <path fill="currentColor" d="M446.7 98.6l-67.6 318.8c-5.1 22.5-18.4 28.1-37.3 17.5l-103-75.9-49.7 47.8c-5.5 5.5-10.1 10.1-20.7 10.1l7.4-104.9 190.9-172.5c8.3-7.4-1.8-11.5-12.9-4.1L117.8 284 16.2 252.2c-22.1-6.9-22.5-22.1 4.6-32.7L418.2 66.4c18.4-6.9 34.5 4.1 28.5 32.2z"></path>
  </symbol>
  <symbol aria-hidden="true" data-prefix="fab" data-icon="instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" id="telegram-si">
  ...
  <symbol aria-hidden="true" data-prefix="fab" data-icon="tiktok" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" id="tiktok-si">
  ...
  <symbol aria-hidden="true" data-prefix="fab" data-icon="pinterest" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" id="pinterest-si">
  ...
  <symbol aria-hidden="true" data-prefix="fas" data-icon="at" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="email-si">
  ...
  <symbol aria-hidden="true" data-prefix="fab" data-icon="viber" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="viber-si">
...
export const viewBox = {
  ...
  location: '0 0 512 512', //todo add icon
  user: '0 0 512 512',
  phone: '0 0 512 512',
  cart: '0 0 512 512',

  'twitter-si': '0 0 512 512',
  'youtube-si': '0 0 576 512',
  'linkedin-si': '0 0 448 512',
  'whatsapp-si': '0 0 448 512',
  'facebook-si': '0 0 448 512',
  'instagram-si': '0 0 448 512',
  'telegram-si': '0 0 448 512',
  'tiktok-si': '0 0 448 512',
  'pinterest-si': '0 0 496 512',
  'email-si': '0 0 512 512',
  'viber-si': '0 0 512 512',
}
